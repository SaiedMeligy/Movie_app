                          ...
                          return Padding(
                            ...
                            child: Stack(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {                                    
                                    navigatekey.currentState!.pushNamed(PageRouteName.details, arguments: viewModel.releases[index] );
                                  },
                                  child: Container(
                                    width: 100,
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: NetworkImage("https://image.tmdb.org/t/p/original/${viewModel.releases[index].posterPath}"),
                                          fit: BoxFit.cover,
                                        )),
                                  ),
                                ),
